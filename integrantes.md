...
|---|---|---|---|
| <img class="gs-member-photo" src="{{ '/assets/img/members/pablo-zdrojewski.jpg' | relative_url }}" alt="Foto de Pablo Zdrojewski" width="44" height="44"> | Pablo Zdrojewski | Coordinador | [pablo.zd@gmail.com](mailto:pablo.zd@gmail.com) |
...
|---|---|---|---|
| <img class="gs-member-photo" src="{{ '/assets/img/members/placeholder.svg' | relative_url }}" alt="Foto pendiente" width="44" height="44"> | Invitado/a 1 | A definir | A definir |
